...
namespace ofxImGui
{
    ...
    void DefaultTheme::setup()
    {
        ...
        style->ChildRounding               = 3.0f;  // Radius of child window corners rounding. Set to 0.0f to have rectangular windows.
        ...
        style->ScrollbarRounding           = 9.0f;  // Radius of grab corners for scrollbar.
        ...
        style->DisplayWindowPadding        = {80,19};  // Window position are clamped to be visible within the display area or monitors by at least this amount. Only applies to regular windows.
        ...
        style->Colors[ImGuiCol_Separator]               = ImVec4(col_win_popup, 0.2f);
