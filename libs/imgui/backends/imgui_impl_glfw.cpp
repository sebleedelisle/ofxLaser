...
{
    xoffset *= GlobalScale::getMouseWheelSpeed() *0.25;
    yoffset *= GlobalScale::getMouseWheelSpeed() *0.25;
    ImGui_ImplGlfw_SetContextFor(window);
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
...
void ImGui_ImplGlfw_CursorPosCallback(GLFWwindow* window, double x, double y)
{
    ...
    x/=GlobalScale::multiplier;
    y/=GlobalScale::multiplier;
#endif

//    ofLogNotice("Mouse update : ") << x << " " << y;
...
{
    //cout << "ImGui_ImplGlfw_CursorEnterCallback" << endl;
    ImGui_ImplGlfw_SetContextFor(window);
    ImGui_ImplGlfw_Data* bd = ImGui_ImplGlfw_GetBackendData();
        ...
        if (is_window_focused)
        {
            ...
            if (bd->MouseWindow == NULL)
            {
                ...
                if (io.ConfigFlags & ImGuiConfigFlags_ViewportsEnable)
                {
                    ...
                    int window_x, window_y;
                    glfwGetWindowPos(window, &window_x, &window_y);
                   // std::cout << "ImGui_ImplGlfw_UpdateMouseData " << mouse_x << " " << mouse_y;
                    mouse_x += window_x;
                    mouse_y += window_y;
                }
