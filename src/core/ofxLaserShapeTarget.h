...
class ShapeTarget {
    ...
    virtual bool addShape(std::shared_ptr<Shape> shapetoadd, bool useClipRectangle, ofRectangle clipRectangle = ofRectangle());
    bool addShapes(vector<std::shared_ptr<Shape>> shapestoadd);

    virtual bool setBounds(const ofRectangle& boundsrect);
    ...
    std::vector <shared_ptr<ofxLaser::Shape>> shapes;
