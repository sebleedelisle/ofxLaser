...
bool ZoneIdContainer :: addZoneIdObject(std::shared_ptr<ObjectWithZoneId> newZoneIdObject) {
...
bool ZoneIdContainer :: addZoneByJson(ofJson& json) {
    ...
    std::shared_ptr<ObjectWithZoneId> zoneIdObject = std::make_shared<ObjectWithZoneId>();
...
map<ZoneId, ZoneId> ZoneIdContainer :: removeZoneById(ZoneId& zoneId) {
    ...
    std::shared_ptr<ObjectWithZoneId> zoneIdObject = getObjectForZoneId(zoneId);
    vector<std::shared_ptr<ObjectWithZoneId>> :: iterator it = find(zoneIdObjects.begin(), zoneIdObjects.end(), zoneIdObject);
...
map<ZoneId, ZoneId> ZoneIdContainer :: moveZoneByIdToIndex(ZoneId& zoneId, int index) {
    ...
    vector<std::shared_ptr<ObjectWithZoneId>> :: iterator from = find(zoneIdObjects.begin(), zoneIdObjects.end(), zoneIdObject);
    vector<std::shared_ptr<ObjectWithZoneId>> :: iterator to = zoneIdObjects.begin()+index;
...
//        for(std::shared_ptr<ObjectWithZoneId>& zoneidobj : zoneIdObjects) {
//            delete zoneidobj;
//        }
        zoneIdObjects.clear();
        return true;
...
vector<std::shared_ptr<ObjectWithZoneId>>& ZoneIdContainer :: getZoneIds(){
    return zoneIdObjects;
    
    
}

std::shared_ptr<ObjectWithZoneId> ZoneIdContainer :: getObjectForZoneId(ZoneId& zoneid) {
    for(std::shared_ptr<ObjectWithZoneId>& zoneidobj : zoneIdObjects) {
...
std::shared_ptr<ObjectWithZoneId> ZoneIdContainer :: getObjectForZoneIdUid(string& uid) {
    for(std::shared_ptr<ObjectWithZoneId>& zoneidobj : zoneIdObjects) {
...
std::shared_ptr<ObjectWithZoneId> ZoneIdContainer :: getObjectAtIndex(int index) {
...
void ZoneIdContainer :: serialize(ofJson& json) {
    ...
    for(std::shared_ptr<ObjectWithZoneId>& zoneIdObject : zoneIdObjects) {
        ofJson zoneIdJson;
