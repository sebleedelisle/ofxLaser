...
class ZoneIdContainer {
    ...
    bool addZoneIdObject(std::shared_ptr<ObjectWithZoneId> newZoneIdObject);
    ...
    bool clearZones(); 
    vector<std::shared_ptr<ObjectWithZoneId>>& getZoneIds(); 
    ...
    std::shared_ptr<ObjectWithZoneId> getObjectForZoneId(ZoneId& zoneid);
    std::shared_ptr<ObjectWithZoneId> getObjectForZoneIdUid(string& uid);
    std::shared_ptr<ObjectWithZoneId> getObjectAtIndex(int index);
    ...
    vector<std::shared_ptr<ObjectWithZoneId>> zoneIdObjects;
    int zoneGroup;
